...
<form class="grid grid-cols-1 min-lg:w-320 md:grid-cols-2 gap-5 min-h-[80vh]">
    <div class="flex flex-col gap-4 h-full">
        <input
            type="text"
            class="bg-gray-600 h-10 w-full rounded px-3 text-white"
            placeholder="Veuillez écrire le titre de votre commentaire"
        >
        <textarea
            class="bg-blue-100 w-full flex-grow p-3 rounded resize-none"
    ...
    <div class="flex flex-col gap-4 h-full items-center md:items-start">
        ...
        <div class="flex flex-row gap-4 items-center w-full max-w-md">
            ...
            <p
                id="fileName"
                class="bg-blue-100 px-4 py-2 mt-2 text-sm text-blue-700 truncate flex-grow"
