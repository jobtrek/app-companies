...
@section('content')
    ...
    <form method="POST" action="{{ route('create.comment', ['id' => $user->id]) }}"
        ...
        <div class="flex flex-col gap-4 h-full">
            ...
            <textarea name="description" class="bg-blue-100 w-full flex-grow p-3 rounded resize-none"
        ...
        <div class="flex flex-col gap-4 md:items-start">
            ...
            <div class="flex flex-row gap-4 justify-center items-center w-full max-w-md">
                ...
                <p id="fileName" class="bg-blue-100 px-4 py-2 mt-2 text-sm text-blue-700 truncate flex-grow">Aucun
                    fichier
                    choisi</p>
                <button type="submit"
                        class="bg-[#1E1D1C] hover:bg-green-700 active:scale-95 active:bg-[#101426] text-white px-4 py-2 transition-all duration-200 ease-in-out rounded">
                    Submit
                </button>
            </div>
