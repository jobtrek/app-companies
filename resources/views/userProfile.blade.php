...
@section('content')
    ...
    <form  method="POST" action="{{ route('users.delete', $user->id) }}"
        ...
        @method('DELETE')
        <button type="submit"
                class="bg-red-600 text-white m-10 hover:bg-blue-300 active:scale-98 active:bg-blue-800 text-black text-center px-4 py-2 rounded-lg w-1/2 transition-all duration-200 ease-in-out">
            Delete
        </button>
    </form>
        @endif
