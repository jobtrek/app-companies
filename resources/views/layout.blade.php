...
<aside
    ...
    <nav class="flex w-full justify-around md:flex-col md:space-y-4 md:justify-start text-sm md:text-base">
        ...
        <a href="{{ route('coach') }}" class="px-3 py-2 sidebar-link text-center md:text-left rounded">Coach -
            commentaires</a>
        <a href="{{ route('create-company') }}" class="px-3 py-2 sidebar-link text-center md:text-left rounded">Formateur
            - Ajouts d'entreprises</a>
        <a href="{{ route('create-account') }}" class="px-3 py-2 sidebar-link text-center md:text-left rounded">Admin -
